...
- Fix SPM mapping for `GCC_PREPROCESSOR_DEFINITIONS` definitions containing special characters (for example, `"`) [#3995](https://github.com/tuist/tuist/pull/3995) by [@adellibovi](https://github.com/adellibovi)
